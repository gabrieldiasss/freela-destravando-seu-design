		...
		<div className="app">
			...
			<div className="page1" >
				...
				<div className="titulo-principal-1">
					<h2 className="chamar-atencao">APRENDA A CRIAR <small>DESIGNS NO PHOTOSHOP</small> E<small> COMO ATRAIR CLIENTES DE TODO PAÍS E ATÉ PELO MUNDO</small>.</h2>
				</div>

				<div className="segunda-parte" >
					<div className="text-segunda-parte">Descubra agora como fazer para atrair clientes bons e com isso alcançar os resultados que sempre desejou fazendo o que ama e tendo liberdade para trabalhar de onde quiser!</div>						
				</div>

				<div className="video">
					<ReactPlayer className="videozao" width='860px' height='530px' controls url='https://youtu.be/v-4yGKPQb_Y' />
				</div>
